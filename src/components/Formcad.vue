...
export default {
    data () {
      return {
        ...
        invalidInfo:false,
        userExiste: false,
        user:{email:'', password:'',nome:'',genero:'',peso:'',altura:'',gluten:Boolean,lactose:Boolean,frutos:Boolean}
      }
    },
    methods: {
    VoltarLogin() {
    ...
    try{
      if(this.user.nome == null || this.user.nome == '' || this.user.email == null || this.user.email == '' || this.user.genero == null || this.user.genero == '' || this.user.peso == null || this.user.peso == '' || this.user.altura == null || this.user.altura == '' || this.user.password == null || this.user.password == ''){
